	...
	public class Tools
	{
		...
		public static void Temizle(GroupBox grp)
		{
			foreach (Control item in grp.Controls)
			{
				...
				else if (item is MetroRadioButton)
					((RadioButton)item).Checked = false;
				else if (item is MetroCheckBox)
		...
		public static bool Sorgula(GroupBox grp)
		{
			foreach (Control item in grp.Controls)
			{
				...
				{
					if (((MetroComboBox)item).SelectedIndex == -1) return false;
				}
			}
			return true;
		}
		...
		public static bool BosAlanVarMi(GroupBox grp)
		{
			foreach (Control item in grp.Controls)
			{
				...
				{
					if (((MetroComboBox)item).SelectedIndex == -1) return true;
				}
