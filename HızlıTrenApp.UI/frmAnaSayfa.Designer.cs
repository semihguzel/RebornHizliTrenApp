namespace HızlıTrenApp.UI
{
    partial class frmAnaSayfa
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mlYonPan = new MetroFramework.Controls.MetroLink();
			...
			this.mlYonPan.TabIndex = 2;
			this.mlYonPan.Text = "Yönetici Paneli";
			this.mlYonPan.Theme = MetroFramework.MetroThemeStyle.Dark;
			this.mlYonPan.Click += new System.EventHandler(this.mlYonPan_Click);
			// 
			// frmAnaSayfa
			// 
			...
			this.Controls.Add(this.mlYonPan);
		...
		private MetroFramework.Controls.MetroLink mlYonPan;
	}
}